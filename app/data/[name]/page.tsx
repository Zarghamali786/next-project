...
async function Data({ params }: Params) {
    ...
    return (
        <div className="justify-between min-h-screen flex items-center">
        <div className="max-w-md mx-auto bg-red-200 rounded-xl shadow-md overflow-hidden md:max-w-2xl m-3 p-4 ">
            <div className="p-8">
